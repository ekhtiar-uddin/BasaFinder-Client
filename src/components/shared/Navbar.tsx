...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {mobileMenu && (
        <div
          className="fixed inset-0 backdrop-blur-sm z-[199]"
      ...
      {/* Mobile Slide-in Drawer — nav এর বাইরে */}
      <div
        className={`lg:hidden bg-white transition-all duration-300 fixed top-0 right-0 h-full shadow-xl z-[200] border-l overflow-hidden
